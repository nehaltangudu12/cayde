<div class="m-8 p-4 bg-indigo-800 rounded flex">
  <div class="flex-none basis-2/6">
    <img src="" alt="Halo Infinite" class="w-full h-48 object-cover rounded-lg">
    <h1 class="text-3xl font-semibold text-white">Halo Infinite</h1>
    <p class="text-white">Shooter, Action</p>
  </div>
